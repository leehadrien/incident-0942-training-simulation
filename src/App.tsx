...
const guideScripts: Record<Phase | 'briefing' | 'tour' | 'dashboard', string> = {
  briefing: 'Welcome to Incident nine forty two. No technical experience is required. Your goal is simple: find what started the checkout problem, stop it from spreading, restore the last working version, and tell the team what happened. First, click two boxes in Live Metrics or Evidence. When Signals shows two of two, choose one decision card. A wrong choice will not end the mission. I will explain what happened, and you can choose again.',
...
const guideAudioUrls: Record<string, string> = {
  'briefing-guide': 'https://d8j0ntlcm91z4.cloudfront.net/user_3HSvE6RMaScRO3uyDW0tlY21tA6/hf_20260807_132504_dfad40db-2455-4c56-ae26-0a274ec730c4.mp3',
  'briefing-guide-challenge': 'https://d8j0ntlcm91z4.cloudfront.net/user_3HSvE6RMaScRO3uyDW0tlY21tA6/hf_20260807_132506_b5f425dd-6ae3-4644-a9e9-637354dfa965.mp3',
...
function NarrationButton({ text, audioKey, label = 'LISTEN TO GUIDE' }: { text: string; audioKey: string; label?: string }) {
    ...
    <main className="dashboard-page">
      <header className="dashboard-header">
        ...
        <div className="dashboard-actions">
          <NarrationButton text={dashboardNarration} audioKey="dashboard-guide" label="LISTEN TO DASHBOARD" />
...
function Simulation() {
  ...
  const briefingNarration = difficulty === 'challenge'
    ? 'Welcome to Incident nine forty two. You selected Challenge mode. Inspect three metrics or evidence cards before making the first decision. Prompts are reduced, answer explanations are hidden, and unsupported actions carry a stronger penalty. Use the evidence to find the cause, contain the spread, recover the working release, and update the team.'
    ...
    <main className="simulation-shell" data-text-size={textSize}>
        ...
        <div className="briefing-backdrop" role="presentation">
          <section className="briefing-modal" role="dialog" aria-modal="true" aria-labelledby="briefing-title" aria-describedby="briefing-summary">
            ...
            <div className="briefing-hero">
              ...
              <NarrationButton text={briefingNarration} audioKey={difficulty === 'challenge' ? 'briefing-guide-challenge' : 'briefing-guide'} label="LISTEN TO THE BRIEFING" />
            </div>
        ...
        <div className="briefing-backdrop" role="presentation">
          <section className="tour-modal" role="dialog" aria-modal="true" aria-labelledby="tour-title">
            ...
            <div className="tour-heading">
              ...
              <NarrationButton text={guideScripts.tour} audioKey="tour-guide" label="LISTEN TO THE INTERFACE TOUR" />
            </div>
      ...
      <header className="topbar">
        ...
        <div className="topbar-actions">
          <button className="utility-button" onClick={() => setBriefingOpen(true)}><span aria-hidden="true">ⓘ</span> MISSION BRIEF</button>
      ...
      <section className="decision-panel panel">
        <div className="decision-heading">
          ...
          {phase !== 'complete' && (
            <div className="decision-tools">
              <NarrationButton text={stepNarration} audioKey={phase === 'diagnose' && difficulty === 'challenge' ? 'diagnose-guide-challenge' : `${phase}-guide`} label="LISTEN TO THIS STEP" />
        ...
        {phase !== 'complete' ? (
          ...
          <div className="completion">
            ...
            <NarrationButton text={guideScripts.complete} audioKey="complete-guide" label="LISTEN TO RESULTS" />
