      ...
      {tourOpen && (
        <div className="briefing-backdrop" role="presentation">
          <section className="tour-modal" role="dialog" aria-modal="true" aria-labelledby="tour-title">
            ...
            <section className="tour-guidance-grid" aria-label="How to use the mission interface">
              <article className={activeFocus === 'briefing' ? 'active' : ''}>
                <span>01</span>
                <strong>START WITH THE LEFT RAIL</strong>
                <p>Read the mission brief, then use Mara’s coaching when you need the technical details explained in plain language.</p>
              </article>
              <article className={activeFocus === 'metrics' || activeFocus === 'evidence' ? 'active' : ''}>
                <span>02</span>
                <strong>READ THE SIGNALS AND EVIDENCE</strong>
                <p>Click the glowing cards on the right. They are the clues that explain what changed and why the checkout flow is failing.</p>
              </article>
              <article className={activeFocus === 'topology' || activeFocus === 'decisions' ? 'active' : ''}>
                <span>03</span>
                <strong>USE THE MAP, THEN CHOOSE</strong>
                <p>The center map shows where the problem is spreading. Once the required signals are inspected, choose one action at the bottom.</p>
              </article>
            </section>
