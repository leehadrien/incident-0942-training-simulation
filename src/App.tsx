...
const guideAudioUrls: Record<string, string> = {
  'briefing-guide': 'https://d8j0ntlcm91z4.cloudfront.net/user_3HSvE6RMaScRO3uyDW0tlY21tA6/hf_20260807_130306_3e71c590-a3da-4444-8d6d-ef34d246816c.mp3',
  'briefing-guide-challenge': 'https://d8j0ntlcm91z4.cloudfront.net/user_3HSvE6RMaScRO3uyDW0tlY21tA6/hf_20260807_131212_390a338f-c3f8-4eaa-a3ec-07e14688649a.mp3',
...
function Simulation() {
  ...
  const briefingNarration = difficulty === 'challenge'
    ? 'Welcome to Incident zero nine forty two. You selected Challenge mode. Inspect three metrics or evidence cards before making the first decision. Prompts are reduced, answer explanations are hidden, and unsupported actions carry a stronger penalty. Use the evidence to find the cause, contain the spread, recover the working release, and update the team.'
        ...
        <div className="decision-heading">
          ...
          {phase !== 'complete' && (
            <div className="decision-tools">
              ...
              <button className="hint-button" onClick={requestHint}>REQUEST HINT <span>{hintCount}</span></button>
            </div>
          )}
        </div>
